...
public final class MusicProtos extends GeneratedFile {
    ...
    private static final GeneratedMessage.FieldAccessorTable internal_static_SEMusic_fieldAccessorTable;
    private static final Descriptors.Descriptor internal_static_SEPlayerInfo_descriptor;
    private static final GeneratedMessage.FieldAccessorTable internal_static_SEPlayerInfo_fieldAccessorTable;
    ...
    public static final class SEMusic extends GeneratedMessage implements SEMusicOrBuilder {
        ...
        static {
            ...
            PARSER = new AbstractParser<SEMusic>() { // from class: com.zh.ble.wear.protobuf.MusicProtos.SEMusic.1
    ...
    public enum SEPlayerControlCommand implements ProtocolMessageEnum {
        ...
        static {
            ...
            internalValueMap = new Internal.EnumLiteMap<SEPlayerControlCommand>() { // from class: com.zh.ble.wear.protobuf.MusicProtos.SEPlayerControlCommand.1
    ...
    public static final class SEPlayerInfo extends GeneratedMessage implements SEPlayerInfoOrBuilder {
        ...
        public enum SEState implements ProtocolMessageEnum {
            ...
            static {
                ...
                internalValueMap = new Internal.EnumLiteMap<SEState>() { // from class: com.zh.ble.wear.protobuf.MusicProtos.SEPlayerInfo.SEState.1
                    @Override // com.google.protobuf.Internal.EnumLiteMap
        ...
        static {
            ...
            PARSER = new AbstractParser<SEPlayerInfo>() { // from class: com.zh.ble.wear.protobuf.MusicProtos.SEPlayerInfo.1
                @Override // com.google.protobuf.Parser
    ...
    static {
        ...
        internal_static_SEMusic_descriptor = messageType;
        internal_static_SEMusic_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(messageType, new String[]{"PlayerInfo", "PlayerControlCommand", "Payload"});
        Descriptors.Descriptor messageType2 = getDescriptor().getMessageType(1);
        internal_static_SEPlayerInfo_descriptor = messageType2;
        internal_static_SEPlayerInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(messageType2, new String[]{"State", "SongTitle", "PlayerName", "SongArtist", "CurrentVolume", "TotalVolume", "TotalProgress", "CurrentProgress", "IconImg", "NosicFitPermissionType"});
